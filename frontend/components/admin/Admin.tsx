...
import { releaseCall } from "../../solana/letter-of-credit-calls";
...
const Admin = () => {
    ...
    const triggerAdminRelease = useCallback(() => {
        (async function () {
            ...
            // if sucessful, update on backend
            if (isReleased) {
                alert("Released on blockchain");
                updateLc();
            } else {
                alert("Failed to release on blockchain");
            }
        })();
    ...
    const updateLc = async () => {
        ...
        console.log(data);
        try {
            const response = await updateFundRelease(id, data);
                        ...
                        <div className={styles.lcm__details__one}>
                            ...
                            <div className={styles.actions}>
                                ...
                                <div className={styles.inner}>
                                    ...
                                    {
                                        publicKey ?
                                            <button onClick={triggerAdminRelease}
